...
| --- | --- | --- | --- | --- | --- |
| `theme-01` | Partial, improved 2026-05-14 wave 24 | renal/hepatic medication-safety guardrails added; exact dose-adjustment table remains local/formulary dependent | CKD/cirrhosis medication-risk framing added; exact perioperative stop/restart chart remains local | escalation when preop risk is unstable; medication restart plan added | obesity, frailty, pregnancy |
...
| `theme-10` | Partial, improved 2026-05-11 wave 23 | NICE NG89 and ASH 2019 international surgery/discharge guardrails added; pediatric and obstetric PONV guardrails added; exact OOKB operation-specific doses remain local | local pediatric/obstetric `PONV` formulary and neuraxial restriction policy | PACU recovery monitoring, failed-discharge escalation, pediatric/obstetric PONV and thromboprophylaxis discharge planning added; local ICU/surgeon acceptance route remains | pediatrics, OSA, breastfeeding |
...
| `theme-17` | Partial, improved 2026-05-11 wave 21 | adult and pediatric TBI/status guardrails added; pediatric severe TBI ICP/CPP/hyperosmolar/seizure guardrails added; anticoagulant reversal doses still need source pass | thrombolysis/anticoagulation exclusions | local ICU/CT/neurosurgery route, pediatric neurocritical route and continuous EEG access remain open | pediatric neurocritical care now has BTF/AES safety layer |
| `theme-18` | Partial, improved 2026-05-14 wave 24 | DKA already МОЗ-framed; urgent `K`, symptomatic `Na`, Ca/Mg/P and refeeding guardrails added; bowel obstruction source-control and antimicrobial guardrails added; renal/hepatic medication-safety guardrails added | renal/hepatic medication cautions improved; exact local dosing remains formulary-dependent | dialysis/RRT triggers and obstruction source-control escalation added; local nephrology/pharmacy/nutrition/surgery pathway remains open | pediatric DKA, pregnancy |
| `theme-19` | Partial, improved 2026-05-14 wave 27 | pediatric airway device-size and `4-2-1` fluid educational anchors added; antibiotic and ventilator settings remain local | airway/drug age restrictions still need local card | transport and post-resuscitation route | neonates vs infants vs older children |
...
| `theme-23` | Partial, improved 2026-05-11 wave 22 | ECTR criteria added; sodium bicarbonate wide-QRS guardrails added; local antidote availability unresolved | mixed-poisoning cautions remain | toxicologist/poison-center escalation local | children and pregnancy |
| `theme-24` | Partial, improved 2026-05-14 wave 26 | component-dose guardrails added; Ukrainian traceability, hemovigilance, labeling and storage guardrails added; actual OOKB component volume and ml/kg policy remain local | reaction recognition added, contraindication nuance local | national hemovigilance frame added; local blood-bank route remains | pediatrics, obstetrics, massive bleeding |
| `theme-25` | Partial, improved 2026-05-14 wave 25 | rapid review refreshed from filled high-risk modules; local SOP refresh remains | inherits local formulary/SOP gaps | inherits local route gaps | pediatric/pregnancy reminders included from existing modules |
...
- МОЗ №2225/2022 and МОЗ №818/2023, used for Ukrainian transfusion traceability, hemovigilance, component labeling, quality and storage guardrails in `theme-24`.
- Український центр трансплант-координації transfusion forms, used to name national working documents for transfusion request, adverse reaction/adverse incident reports, unique blood-system subject identifiers and order logs.
...
- Local PDF `Алгоритм_дій_дитячого_анестезіолога_2020_1.pdf`, reviewed 2026-05-14 as an educational source: used only for pediatric LMA/ETT size anchors and the `4-2-1` maintenance-fluid rule in `theme-19`; it is not a local SOP and does not replace current labels, МОЗ/ДЭЦ standards, or device instructions.
- AAP Clinical Practice Guideline: Maintenance Intravenous Fluids in Children, 2018, used as an international cross-check for pediatric maintenance-fluid composition: most children aged 28 days to 18 years requiring maintenance IV fluids should receive isotonic solutions with appropriate KCl/dextrose; rate and local solution remain clinical/local decisions.
- Local PDF `Контроль_периопераційного_болю_1.pdf`, reviewed 2026-05-14 as an adapted pain-control guideline/project: useful for future pain-assessment and PCA/PCEA organization checks, but not a final active MOH order in this review.
- Local PDFs `Невідкладні стани в педіатрії 2020.pdf` and `Невідкладні стани в педіатрії 2023.pdf`, reviewed 2026-05-14 as educational pediatric-emergency sources; 2023 is the preferred study layer for future pediatric emergency cross-checks, while active МОЗ/ДЭЦ CPR/newborn/diabetes standards remain primary.
...
- AASLD 2022 decompensated-cirrhosis practice guidance and VA liver medication-safety material, used as an international medication-safety layer for `НПВП`, acetaminophen/paracetamol, opioids, sedatives and encephalopathy risk where Ukrainian perioperative cirrhosis drug tables are not represented.
...
- NICE NG89 `Venous thromboembolism in over 16s`, published 2018 and last updated 2019, used as the international layer for hospitalized surgical/trauma VTE risk assessment, discharge instructions, abdominal/cancer/orthopedic/neuro/trauma prophylaxis duration and procedure-specific guardrails in `theme-10`.
- ASH 2019 VTE prevention guideline for hospitalized surgical patients, used for major-surgery mechanical/pharmacological framing, `IPC` preference over stockings when mechanical prophylaxis is selected, extended prophylaxis language and routine `IVC filter` avoidance in `theme-10`.
...
- Surgical Infection Society 2024 intra-abdominal infection guideline, IDSA 2024 complicated intra-abdominal infection guideline, and GAIS/WSES 2024 intra-abdominal infection position statement, used for `theme-18` source-control urgency, culture/de-escalation framing and short-course antibiotics after adequate source control. These do not replace local OOKB empiric antibiotic tables.
